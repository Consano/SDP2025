...
# Hardcoded default file paths - Jack
...
# This is intended to get the environment variables from setup.sh, its now hardcoded above -Jack
...
class SegformerProfile: 
    ...
    def get_n_samples_coco(self, num_runs: int = 10, batch_size: int = 1):
        ...
        #Sanity check line to make sure dataset is correctly read -Jack
